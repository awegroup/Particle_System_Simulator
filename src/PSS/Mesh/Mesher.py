...
class Mesher:
    ...
    def add_rectangle(
        self, upper_left, lower_right, mesh_type, mesh_edge_length=1, angle=0
    ):

        self.shapes.append(
            Rectangle(upper_left, lower_right, mesh_type, mesh_edge_length, angle=0)
        )
...
class Rectangle(Geometry):
    def __init__(self, upper_left, lower_right, mesh_type, mesh_edge_length=1, angle=0):
        self.mesh_types = {
            "square": self.mesh_square,
            "sq": self.mesh_square,
